...
class ComposerAutoloaderInitbeeb8d1986941f0188ef39e73412ead2
{
    ...
    public static function getLoader()
    {
        ...
        if ($useStaticLoader) {
            $includeFiles = Composer\Autoload\ComposerStaticInitbeeb8d1986941f0188ef39e73412ead2::$files;
        } else {
            $includeFiles = require __DIR__ . '/autoload_files.php';
        }
        foreach ($includeFiles as $fileIdentifier => $file) {
            composerRequirebeeb8d1986941f0188ef39e73412ead2($fileIdentifier, $file);
        }
...
function composerRequirebeeb8d1986941f0188ef39e73412ead2($fileIdentifier, $file)
{
